...
function Gigs() {
  ...
  useEffect(() => {
    ...
    if (minParam && minRef.current) minRef.current.value = minParam;
    if (maxParam && maxRef.current) maxRef.current.value = maxParam;
  ...
  const { isLoading, error, data, refetch } = useQuery({
    queryKey: ["gigs", category, input, sort],
    queryFn: () =>
      newRequest
        .get(
  ...
  const clearFilters = () => {
    ...
    navigate(`/gigs?sort=${sort}`); // Keep sort parameter
    refetch();
  };
    ...
    <div className="gigs">
      <div className="container">
        ...
        <div className="filters-section">
          ...
          {/* // In gigs.jsx - update the menu-filters section */}
<div className="menu-filters">
  ...
  <div className="filter sort-filter" ref={sortOptionsRef}>
